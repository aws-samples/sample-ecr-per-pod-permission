...
ENVSUBST_VARS='${ACCOUNT_ID} ${REGION} ${CLUSTER_NAME} ${ECR_SHARED_REPO_URL} ${ECR_TEAM_A_REPO_URL} ${ECR_TEAM_B_REPO_URL} ${IRSA_ROLE_ARN_TEAM_A} ${IRSA_ROLE_ARN_TEAM_B}'
...
if [ "$ACTION" = "apply" ]; then
  ...
  for f in "$MANIFEST_DIR"/team-*.yaml; do
